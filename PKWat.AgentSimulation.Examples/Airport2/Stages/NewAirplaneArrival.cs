...
public class NewAirplaneArrival(IRandomNumbersGenerator randomNumbersGenerator, ISimulationCalendarScheduler simulationCalendarScheduler) : ISimulationStage
{
    ...
    private void ScheduleNextAirplaneArrival(ISimulationContext context, TimeSpan? lastArrival = null)
    {
        ...
        simulationCalendarScheduler.ScheduleNewStepAt(nextArrival);
    }
}
