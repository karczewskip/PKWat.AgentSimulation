...
using PKWat.AgentSimulation.ExamplesVisualizer.Simulations.AntColony.Stages;
using System;
using System.Windows.Media.Imaging;

public class AntColonySimulationBuilder(ISimulationBuilder simulationBuilder, ColonyDrawer colonyDrawer) : IExampleSimulationBuilder
{
    public ISimulation Build(Action<BitmapSource> drawing)
    {
        var simulation = simulationBuilder
            ...
            .AddInitializationStage<AddFoodSources>(s =>
            {
                ...
                s.AddFoodSource(new FoodSource { SizeRadius = 5, Coordinates = ColonyCoordinates.CreateAt(80, 10) });
            })
            .AddAgents<Ant>(400)
